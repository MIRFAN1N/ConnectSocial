                    ...
                    <div class="col-md-6">
                        <div class="user-profile-info-inner">
                            ...
                            <div class="user-profile-info-text">
                                <h2 class="user-profile-info-text-name">Jane Doe</h2>
                                <div class="user-profile-info-text-type"><i>Ambassador</i></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="user-profile-info-action-inner text-center">
                            ...
                            <div class="user-profile-info-action-buttons">
                                <button class="user-profile-btn-large white mr-3">Join as Merchant</button>
                                <button class="user-profile-btn-large black">Join as Ambassador</button>
                            </div>
                        </div>
                    </div>
                </div>
